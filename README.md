...
Canteen ordering during peak hours usually means 🧍‍♂️🧍‍♀️ long queues, confusion, and no way to know when your food will actually be ready. There's no centralized way to manage multiple counters or orders — so everyone just waits and guesses. 🤷
...
- 🧑‍🍳 **Admin Panel** — admins manage the daily menu 🗓️ and update item availability in real time ⚡
